...
{
    //Untuk Singleton
    public static NarationController Instance { get; private set; }
    ...
    private NarationSpeaker currentSpeaker;
    ...
    public void SetCurrentSpeaker(NarationSpeaker speaker)
    {
        currentSpeaker = speaker;
    }

    public GameObject GetDialogueBG()
    {
        return dialogueBG;
    }
